...
headers_without_include_guards = [os.path.join(*x.split('/')) for x in ['icu/common/bytesinkutil.h', 'icu/common/norm2_nfc_data.h', 'icu/common/propname_data.h', 'icu/common/ubidi_props_data.h', 'icu/common/ucase_props_data.h', 'icu/common/uchar_props_data.h', 'icu/common/unicode/urename.h', 'icu/common/unicode/brkiter.h', 'icu/common/unicode/ubrk.h', 'icu/i18n/unicode/ureldatefmt.h', 'icu/i18n/unicode/search.h', 'icu/i18n/unicode/stsearch.h', 'icu/i18n/brktrans.h', 'icu/i18n/unicode/usearch.h', 'icu/common/locutil.h', 'icu/common/unicode/ucnv_err.h', 'icu/common/ucnv_io.h', 'icu/common/ustr_cnv.h', 'icu/common/unicode/ucnv.h']]
...
final_included_files = [os.path.join(*x.split('/')) for x in final_included_files]
